...
@ApiModel
public class TitleSearchResponse implements ApiResponse {
    ...
    public void setPagination(int maxItems, int offset, String queryString, boolean firstPage, boolean lastPage) {
        ...
        if (!lastPage) {
            if (queryString.contains("offset=")) {
                ...
                this.setNextPage(linkToService + "/titlesearch?" + queryStringNextPage);
            } else {
        ...
        if (!firstPage) {
            if (queryString.contains("offset=")) {
                ...
                this.setPreviousPage(linkToService + "/titlesearch?" + queryStringPreviousPage);
            } else {
                this.setPreviousPage(linkToService + "/titlesearch?" + queryString + "&offset=" + previousOffset);
            }
        }
    }
}
