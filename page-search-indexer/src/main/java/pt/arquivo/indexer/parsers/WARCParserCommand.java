...
import pt.arquivo.indexer.solr.SolrDocumentWrapper;
                ...
                try {
                    ...
                    try {
                        ...
                        if (doc != null) {
                            ...
                            solrDocumentWrapper.setAnchor(doc.getAnchor());
                            solrDocumentWrapper.setCollection(doc.getCollection());
                            solrDocumentWrapper.setContent(doc.getContent());
                            solrDocumentWrapper.setContentLength(doc.getContentLength());
                            solrDocumentWrapper.setDigest(doc.getDigest());
                            solrDocumentWrapper.setTimeStamp(String.valueOf(doc.getTstamp()));
                            solrDocumentWrapper.setEncoding(doc.getEncoding());
                            solrDocumentWrapper.setId(doc.getId());
                            solrDocumentWrapper.setTitle(doc.getTitle());
                            ...
                            listDocs.add(solrDocumentWrapper);
                        }
                        log.debug(doc);
                    } catch (Exception e) {
                        continue;
